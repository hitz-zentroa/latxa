...
def evaluate_eus_reading(split="test", model="gpt-3.5-turbo", shots=5, limit=1, start=0):
    # Load your dataset from Hugging Face
    print(f"Loading {split} split...")
    dataset = load_eus_reading()
    ...
    for i, item in enumerate(dataset):
        ...
        with open(f"../results/{model}/eus_reading_{split}_{shots}-shot.jsonl", "a") as f:
